...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <a href="{{route('admin_slide.create')}}"><button type="submit"class="btn btn-outline-primary">Thêm slide</button></a>
        </div>
        <div class="card-body">
            ...
            @foreach($slide as $item)
                 <tr>
                    ...
                    <td>{{$item->status()}}</td>
                    <td>
                        <a href="{{route('admin_slide.edit',$item->id)}}"><i class="fa fa-edit" style="font-size:36px"></i></a>
                        ...
                        <div class="ilv-btn-group">
                            <form action="{{route('admin_slide.destroy',$item->id)}}" method="post">
