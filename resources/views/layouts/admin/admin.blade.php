    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="" style="font-family:Myriad Pro">Đồng Hồ Duy Khương</a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{route('admin_drash')}}"> <i class="fa fa-home"></i><big style="margin-left:15%">Tổng Quan</big></a>
                    </li>
                    

                    <li>
                        <a href="{{route('admin_category.index')}}"><i class="fa fa-calendar-plus-o"></i><big style="margin-left:15%">Quản Lý Thương Hiệu</big></a>
                    </li>
                    <li>
                        <a href="{{route('admin_product.index')}}"><i class="fa fa-id-card-o"></i><big style="margin-left:15%">Quản Lý Sản Phẩm</big></a>
                    </li>
                    <li>
                        <a href="{{route('admin_slide.index')}}"><i class="fa fa-barcode"></i><big style="margin-left:15%">Quản Lý Slide</big></a>
                    </li>
                    <li>
                        <a href="{{route('user.index')}}"><i class="fa fa-user-circle"></i><big style="margin-left:15%">Quản Lý Người Dùng</big></a>
                    </li>
                    <li>
                        <a href="{{route('admin_order.index')}}"><i class="	fa fa-building-o"></i><big style="margin-left:15%">Quản Lý Hóa Đơn</big></a>
                    </li>
                    <li>
                        <a href="{{route('admin_comment.index')}}"><i class="fa fa-calendar-check-o"></i><big style="margin-left:15%">Quản Lý Bình Luận</big></a>
                    </li>
                    <li>
                        <a href="{{route('admin_contact.index')}}"><i class="fa fa-address-book"></i><big style="margin-left:15%">Quản Lý Liên Hệ</big></a>
                    </li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{asset('sufee/images/admin.jpg')}}" alt="User Avatar" height="40" width="40">
                        </a>
